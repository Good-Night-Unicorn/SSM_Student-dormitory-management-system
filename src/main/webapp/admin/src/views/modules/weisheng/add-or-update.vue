    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="susheId" name="susheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="得分" prop="jifenjiluNumber">
                       <el-input v-model="ruleForm.jifenjiluNumber"
                                 placeholder="得分" clearable  :readonly="ro.jifenjiluNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="得分" prop="jifenjiluNumber">
                           <el-input v-model="ruleForm.jifenjiluNumber"
