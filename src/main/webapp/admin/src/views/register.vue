    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">学生宿舍管理系统注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="宿管姓名" class="input" v-if="tableName=='suguan'">
                            <el-input v-model="ruleForm.suguanName" autocomplete="off" placeholder="宿管姓名"  />
                        </el-form-item>
                        <el-form-item label="宿管手机号" class="input" v-if="tableName=='suguan'">
                            <el-input v-model="ruleForm.suguanPhone" autocomplete="off" placeholder="宿管手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='suguan'">
                            <el-input v-model="ruleForm.suguanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('suguan' == this.tableName && this.ruleForm.suguanPhone&&(!this.$validate.isMobile(this.ruleForm.suguanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('suguan' == this.tableName && this.ruleForm.suguanEmail&&(!this.$validate.isEmail(this.ruleForm.suguanEmail))){
