    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xuesheng !=null){
            ...
            BeanUtils.copyProperties( xuesheng , view );//把实体数据重构到view中
                ...
                //级联表
                SusheEntity sushe = susheService.selectById(xuesheng.getSusheId());
                if(sushe != null){
...
//                            xueshengEntity.setSusheId(Integer.valueOf(data.get(0)));   //宿舍 要改的
...
//                            xueshengEntity.setXueshengQq(data.get(0));                    //QQ号 要改的
//                            xueshengEntity.setXueshengPhoto("");//照片
//                            xueshengEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            xueshengEntity.setZhiweiTypes(Integer.valueOf(data.get(0)));   //职位 要改的
